...
--step 5: update display order for 3rd quarter 2020
--

update [qmr].dbo.displayorder2020
set displayorder = 10
where year = 2020 and quarter = '3rd quarter'  and reporting = 1 
and title = 'VIP Customer Service';

update [qmr].dbo.displayorder2020
set displayorder = 11
where  (year=2020) and (quarter in ('3rd quarter')) and reporting = 1
and title like 'KPM Customer Service%';

update [qmr].dbo.displayorder2020
set displayorder = 12
where  (year=2020) and (quarter in ('3rd quarter')) and reporting = 1
and title like 'KPM: ERT';
...
----
update [qmr].dbo.displayorder2020
set displayorder = 811
where  (year=2020) and (quarter in ('3rd quarter')) and reporting = 1
and title like 'KPM: Boards and Commission';
